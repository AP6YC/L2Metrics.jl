# ---
# title: L2Metrics Tutorial
# id: pycalljld2-tutorial
# date: 2023-7-21
# cover: ../assets/julialang_logo_icon.png
# author: "[Sasha Petrenko](https://github.com/AP6YC)"
# julia: 1.9
# description: This demo provides a quick example of how to run the L2Metrics package for saving and loading PyCall objects with JLD2.
# ---

# ## Overview

# This demo shows how to get started with `L2Metrics.jl`.
...
# # To use this package, you must load `PyCall`, `JLD2`, and `L2Metrics` in the context that you intend to do model saving and loading:

# ## Load the modules into the current context
# using
#     PyCall,     # for PyObjects
#     JLD2,       # for saving and loading
#     L2Metrics  # for telling JLD2 how to save and load PyObjects
