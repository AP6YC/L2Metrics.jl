...
# Description
This file builds the documentation for the L2Metrics.jl package
...
# top_url = raw"https://media.githubusercontent.com/media/AP6YC/FileStorage/main/L2Metrics/"
...
# # Make a destination for the files, accounting for when folder is L2Metrics.jl
...
makedocs(
    ...
    repo="https://github.com/AP6YC/L2Metrics.jl/blob/{commit}{path}#L{line}",
    sitename="L2Metrics.jl",
...
deploydocs(
    repo="github.com/AP6YC/L2Metrics.jl.git",
    devbranch="develop",
